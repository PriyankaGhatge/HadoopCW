/*To find Highest paid employee Name,Salary and Department in each City*/
...
public class Seventh {
	public static class MapperEx extends Mapper<Object, Text, Text, Text> {
		...
		String dept = arr[3];
		ctx.write(new Text(city), new Text(Emp_name+ "-" +sal+"-"+dept));
		}
		}
	...
	s = arr[0].toString();
	Dept1 =arr[2].toString();
	}

	}
	context.write(new Text(key), new Text(s.toString() +"-"+Dept1.toString()+"-" + sal.toString()));
